                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" class="" @change="updateProfile" id=""
                                                placeholder="">

                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="password" class="col-sm-2 col-form-label">Password (Leave Blank for no Change)</label>
                                        <div class="col-sm-10">
        ...
        methods : {
            updateProfile(e) {
                ...
                if(file['size'] < 2111775) {
                    ...
                    swal.fire(
                        'Failed',
                        'The uploading file size is too big. Use less than 2 MB',
                        'error'
                    );
                }
